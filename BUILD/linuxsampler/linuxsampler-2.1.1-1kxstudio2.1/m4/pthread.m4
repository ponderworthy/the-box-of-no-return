dnl Copyright © 2007 Steven G. Johnson <stevenj@alum.mit.edu>
dnl
...
dnl flags, but also link it with them as well. e.g. you should link with
...
dnl you have any other suggestions or comments. This macro was based on
dnl work by SGJ on autoconf scripts for FFTW (http://www.fftw.org/) (with
dnl help from M. Frigo), as well as ac_pthread and hb_pthread macros posted
dnl by Alejandro Forero Cuervo to the autoconf macro repository. We are also
